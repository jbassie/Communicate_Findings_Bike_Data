...
This is a Nanodegree requirement project from Udacity. The project aims to communicate findings from the data of bike trips from FordGo Bikes. 
...
## Dataset
This document explores the Ford GoBike's trip data for public containing approximately 30,15,214 bike rides for February, 2018. The attributes included the trip start/end time, as well as additional measurements such as user type, gender, and age. 155K data points were removed from the analysis due to inconsistencies in the birth date, which in some cases was dated prior 1900. The data is available [here](https://s3.amazonaws.com/fordgobike-data/index.html).
